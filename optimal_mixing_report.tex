...
\centering
\textbf{\color{red!70!black}Superseded draft --- preserved for historical record.}\\[3pt]
\footnotesize
This is an earlier, uncorrected draft of this report. It has been superseded
by \texttt{optimal\_mixing\_thesis\_report.pdf} in this repository, which
fixes a mismatched reference file and tightens several claims, including the
resolution-sensitivity discussion in Section~\ref{sec:resolution} and the
precise meaning of ``reproducing the original results to four decimal
places'' (the reproduction is of the author's own MATLAB implementation's
output, not of numerical values published in a peer-reviewed paper). This
draft is kept unmodified for the record; see the corrected thesis report for
